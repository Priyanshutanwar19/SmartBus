...
export default function HeroSlider() {
  ...
  return (
    <div className="relative h-64 sm:h-80 md:h-[28rem] flex items-center justify-center overflow-hidden bg-gradient-to-r from-indigo-700 via-purple-500 to-pink-400 animate-gradient-x">
      <img
        src={images[index]}
        alt="Travel"
