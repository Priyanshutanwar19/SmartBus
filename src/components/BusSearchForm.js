...
export default function BusSearchForm({ onSearch }) {
  ...
  return (
    <form className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg p-4 md:p-6 space-y-4 md:space-y-0 md:grid md:grid-cols-10 md:gap-4 md:items-end" onSubmit={handleSubmit}>
      {/* From */}
