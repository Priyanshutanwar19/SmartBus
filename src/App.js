...
import OperatorStates from "./pages/operator/OperatorStates";
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/operator/states" element={<OperatorProtectedRoute><OperatorStates /></OperatorProtectedRoute>} />
